...
if __name__ == "__main__":
    ...
    while True:
        ...
        ax.cla()
        ax.plot(data["close"].iloc[-window_size:])
        ax.plot(hold[-window_size:], marker="o", linestyle="", color="gray")
        ax.plot(buy[-window_size:], marker="o", linestyle="", color="green")
        ax.plot(sell[-window_size:], marker="o", linestyle="", color="red")
